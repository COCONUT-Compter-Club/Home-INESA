              ...
              <div className="flex flex-col justify-center" data-aos="fade-up" data-aos-delay="200">
                ...
                <div className="mt-8" data-aos="fade-up" data-aos-delay="450">
                  ...
                  <div className="flex space-x-4">
                     {/* LinkedIn */}
                    <a href="https://www.linkedin.com/company/coconut-computer-club" className="bg-green-600 text-white p-3 rounded-full hover:bg-green-700 transition duration-200">
